  ...
  return (
    <div className="min-h-screen bg-[var(--bg-color)] text-[var(--text-primary-color)] font-sans flex flex-col">
      ...
      <section className="flex-1 flex flex-col items-center justify-center p-6 mt-20 mb-24 animate-in fade-in slide-in-from-bottom-4 duration-1000">
        ...
        {/* Task Assigner Teaser */}
        <div className="mt-4 bg-[#111111] border border-[#1a1a1a] rounded-xl p-6 max-w-lg w-full flex flex-col items-center text-center animate-in fade-in slide-in-from-bottom-6 duration-1000 delay-500">
          <div className="bg-[#00ff88]/10 text-[#00ff88] text-[10px] font-bold px-2 py-1 rounded uppercase tracking-wider mb-3">
            New Feature
          </div>
          <h3 className="text-xl font-bold text-white mb-2 font-mono">Task Assigner</h3>
          <p className="text-[#666666] text-sm mb-6">
            Fetch GitHub contributors, add their skills, let AI assign the right person to the right task
          </p>
          <button
